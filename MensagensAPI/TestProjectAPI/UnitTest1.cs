...
namespace TestProjectAPI2022
{
    ...
    public class UnitTest1
    {
        ...
        {
            var result = ChamaApiPost("https://localhost:7027/api/List").Result;
        ...
        public void GetToken()
        {
            ...
            string urlApiGeraToken = "https://localhost:7027/api/CriarTokenIdentity";

            using (var cliente = new HttpClient())
            {
                string login = "hyl.silva@gmail.com";
                string senha = "Qwe123123!";
                var dados = new
                {
                    email = login,
                    senha = senha,
